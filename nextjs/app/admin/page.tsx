      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-4 text-sm text-gray-600">
            ...
            ylläpitäjää,{" "}
            <span className="font-medium">{stats.users.users}</span> käyttäjää
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-4 text-sm text-gray-600">Workspace-käyttäjiä</div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-4 text-sm text-gray-600">
            <span className="font-medium">{stats.bookings.upcoming}</span>{" "}
            tulevaa varaus
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-4 text-sm text-gray-600">Menneitä varauksia</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <p className="text-gray-600 text-sm">
            Tarkastele, muokkaa ja hallitse käyttäjätilejä
          </p>
        </Link>
        <Link
          href="/admin/settings"
