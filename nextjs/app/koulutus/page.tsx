...
export default function Page() {
  return (
    <div className="min-h-screen flex flex-col w-full">
      ...
      <ContentSection variant="dark">
        <div className="mb-12">
          ...
          <p className="text-lg text-swhite/80 text-center max-w-3xl mx-auto mb-12">
            Annamme lentokoulutusta kolmessa eri lupakirjatyypissä.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex gap-6 items-start">
            ...
            <div>
              ...
              <p className="text-swhite/80">
                Suorita teoriaopinnot, lentotunnit ja kokeet. Lopulta teet
                koelennon ja saat lupakirjasi - olet virallisesti lentäjä!
              </p>
            </div>
          </div>
        </div>
      ...
      <ContentSection variant="gradient" backgroundImage="bg-punkaharju-one">
        <div className="max-w-4xl mx-auto">
