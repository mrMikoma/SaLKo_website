      ...
      <section className="relative w-full min-h-screen flex items-center justify-center bg-cover bg-center bg-olavinlinna-one">
        ...
        <div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 pt-48 pb-16">
          <div className="text-center space-y-6 animate-fade-in mt-10 mb-20 md:mt-12 md:mb-24">
            ...
            <h2 className="text-xl md:text-2xl font-bold leading-tight text-swhite/70">
          ...
          <div className="space-y-12">
            ...
            <div className="glass rounded-lg p-6 md:p-8 border border-sred/20">
              <div className="text-center space-y-4">
                <p className="text-lg md:text-xl text-swhite leading-relaxed">
                  Haaveileeko sinä lentämisestä? Esittelylento on loistava tapa
                  tutustua ilmailun maailmaan ja kokea lentämisen ilo
                  Savonlinnan lentokentältä käsin.
                </p>
                <p className="text-lg md:text-xl text-swhite leading-relaxed">
                  Esittelylennoillamme pääset kokemaan Savonlinnan upean
                  maiseman linnunperspektiivistä ja saat ainutlaatuisen
                  elämyksen!
                </p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-sbluel pl-4">
                  ...
                  <p className="text-swhite/70 mb-2">
                    ...
                    koulutusprosessiin. Sovittava erikseen lennonopettajan
                    kanssa.
                  </p>
                  <Link
                    className="text-sred font-semibold"
                    href="/yhteystiedot"
                  >
                ...
                <div className="border-l-4 border-sbluel pl-4">
                  ...
                  <p className="text-swhite/70 mb-2">
                    Yksittäisen lentäjän kanssa sovittavat ei-kaupalliset
                    lennot, jotka noudattavat kulujenjakoperiaatetta. Näissä
                    lennoissa lentäjä jakaa lennon kustannukset kyydissä olevien
              ...
              <div className="space-y-4 text-swhite/80">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-base">
                      Lennot ovat aina sääriippuvaisia. Mikäli sääolosuhteet
                      eivät salli turvallista lentämistä, lennon ajankohta
                      siirretään sopivampaan ajankohtaan.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="glass rounded-lg p-6 md:p-8 border border-sred/20">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-swhite/70">
                    Kyllä! Lennon aikana voit ottaa kuvia ja videoita.
                    Muistathan kuitenkin noudattaa lentäjän ohjeita ja
                    varmistaa, että kuvaaminen ei häiritse lentoa tai
                    turvallisuutta.
                  </p>
                </div>
                <div>
            ...
            <div className="glass rounded-lg p-6 md:p-8 border border-sbluel/20">
              ...
              <div className="space-y-4 text-swhite/80">
                <p className="text-base leading-relaxed">
                  ...
                  kaupallisen lentotoiminnan turvallisuus- ja
                  vakuutusvaatimuksia.
                </p>
                <p className="text-base leading-relaxed">
