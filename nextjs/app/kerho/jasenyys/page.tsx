...
export default function Page() {
  return (
    <div className="min-h-screen flex flex-col w-full">
      <section className="relative w-full min-h-screen flex items-center justify-center bg-cover bg-center bg-punkaharju-one">
        ...
        <div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 pt-48 pb-16">
          <div className="text-center space-y-6 animate-fade-in mt-10 mb-20 md:mt-12 md:mb-24">
            <h2 className="text-2xl md:text-2xl lg:text-3xl font-bold leading-tight text-swhite/80">
              Kiinnostaako ilmailu ja lentäminen?
            </h2>
            <h2 className="text-1xl md:text-2xl font-bold leading-tight text-swhite/70">
              Ensimmäinen askel kohti lentämisen maailmaa on liittyä lentokerhon
              jäseneksi!
            </h2>
          </div>
              ...
              <div className="space-y-4 text-swhite/80">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-md">
                      Ota yhteyttä kerhon hallitukseen sähköpostitse,
                      puhelimitse tai sovi tutustuminen lentokentälle ja ilmaise
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-md">
                      Täytä jäsenhakemus ja toimita se kerhon hallitukselle.
                      Voit tiedustella hakemusta ottamalla yhteyttä
                      hallitukseen.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-md">
                      Kun hakemuksesi on hyväksytty, maksa vuosittainen
                      jäsenmaksu suoraan kerholle tai Suomen Ilmailuliiton
                      kautta.
                    </p>
                  </div>
                </div>
